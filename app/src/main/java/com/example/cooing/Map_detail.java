...
public class Map_detail extends AppCompatActivity {
    ...
    private void uploadData() {
        ...
        // POST 요청 생성
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://cooing.dothome.co.kr/write_update.php",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        Toast.makeText(Map_detail.this, "Data uploaded successfully", Toast.LENGTH_SHORT).show();
                    }
                },
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Map_detail.this, "Error uploading data", Toast.LENGTH_SHORT).show();
                    }
                }
        ) {
            @Override
